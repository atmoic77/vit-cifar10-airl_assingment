...
<br> <br>
**Note: the images in the notebook are loaded and disaplayed locally , it is mainly for representation and understanding purpose , while running the vit_cifar10.ipynb file ,the code structres will be fully functional but images won't load again ,to refer visuals go through the (.ipynb) file once in starting then run it for further evaluation** 
<br> <br>
